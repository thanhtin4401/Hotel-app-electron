        ...
        <div className="flex flex-col">
          ...
          <nav className="nav">
            <ul className="nav-links">
              <li
                className={
                  splitLocation[2] === "Statistical"
                    ? "active nav-links-item"
                    : "nav-links-item"
                }
              >
